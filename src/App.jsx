      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            <div className="flex items-center gap-3 mb-6 bg bg-zinc-800 w-fit p-4 rounded-2xl">
              ...
              <q>Being Normal is Boring</q>
            </div>
            <h1 className="text-5xl font-bold mb-6">
              <ShinyText text="Hi I'm Umesh Shakya" disabled={false} speed={3} className='custom-class' />
            </h1>
            <BlurText
              text="DevOps Engineer & MERN Stack Developer focused on building scalable applications, automating workflows, and creating modern user-friendly solutions while continuously learning new technologies."
              delay={150}
              animateBy="words"
              direction="top"
              className=" mb-6"
          ...
          <div className="md:ml-auto animate__animated animate__fadeInUp animate__delay-4s">
            <ProfileCard
              name="Umesh Shakya"
              title="DevOps Engineer | MERN Developer"
              handle="again.keys"
              status="Online"
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <div className="basis-full md:basis-7/12 pr-0 md:pr-8 border-b md:border-b-0 md:border-r border-violet-500/30">
              ...
              <div className="flex-1 text-left">
                ...
                <BlurText
                  text="I’m driven by curiosity and a passion for building systems that just work. As a DevOps and MERN Stack developer, I focus on creating scalable, reliable, and user-friendly applications while bridging the gap between development and production. I enjoy learning new technologies, optimizing workflows and pipelines, and developing efficient solutions that are both dependable and innovative."
                  delay={150}
                  animateBy="words"
                  direction="top"
                ...
                <ShinyText
                  text="'Turning complexity into automation.'"
                  disabled={false}
                  speed={3}
        ...
        <div className="kontak mt-32 sm:p-10 p-0" id="contact">
          ...
          <p
            ...
            data-aos-once="true"
          >
            Get in touch with Umesh or chat in real-time
          </p>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1">
              <form
                action="https://formsubmit.co/kkeys354@gmail.com"
                method="POST"
